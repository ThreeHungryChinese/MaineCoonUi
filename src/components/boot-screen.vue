<template>
    ...
    ">
        ...
        <h1 style="
        font-weight: 300;
        color: #fff;">Automation Admission Platform</h1>
        <h3 style="color: #eee;	font-weight: 100;">
        <a style="color: #ddd;"  href="https://github.com/ThreeHungryChinese" target="_blank">
        Github 
